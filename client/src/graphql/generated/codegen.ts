...
export type SearchPageQuery = {
  ...
  allTags: Array<{ tags: Array<string> }>;
};

export type AllSlugsQueryVariables = Exact<{ [key: string]: never }>;

export type AllSlugsQuery = { slugs: Array<{ slug: string }> };
 ...
 * });
 */
export function useTopPageQuery(
  baseOptions?: Apollo.QueryHookOptions<TopPageQuery, TopPageQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TopPageQuery, TopPageQueryVariables>(
    TopPageDocument,
    options
  );
}
export function useTopPageLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TopPageQuery, TopPageQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TopPageQuery, TopPageQueryVariables>(
    TopPageDocument,
    options
  );
}
...
export type TopPageQueryResult = Apollo.QueryResult<
  TopPageQuery,
...
export function useSearchPageQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SearchPageQuery, SearchPageQueryVariables>(
    SearchPageDocument,
    options
  );
}
export function useSearchPageLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SearchPageQuery, SearchPageQueryVariables>(
    SearchPageDocument,
    options
  );
}
export type SearchPageQueryHookResult = ReturnType<typeof useSearchPageQuery>;
export type SearchPageLazyQueryHookResult = ReturnType<
  typeof useSearchPageLazyQuery
>;
export type SearchPageQueryResult = Apollo.QueryResult<
  SearchPageQuery,
  SearchPageQueryVariables
>;
